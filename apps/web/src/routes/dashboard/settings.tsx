...
function LocationSettings() {
  ...
  const onSubmit = (data: LocationSettingsFormData) => {
    updateProfileMutation.mutate({
    ...
    <Panel>
      <PanelHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Set your location to see weather in your daily brief
        </p>
      </PanelHeader>
      <PanelContent>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Enter a city name (e.g., "San Francisco, CA") or coordinates
                  </p>
                  <FormMessage />
                </FormItem>
              )}
...
function BankStatementsSettingsSection() {
  const [copied, setCopied] = useState(false);

  const configExample = `notifications:
  discordWebhookUrl: "https://discord.com/api/webhooks/..."

reporting:
  eaApiUrl: "http://localhost:3000"`;
  ...
  return (
    <Panel>
      <PanelHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Configure bank statement automation notifications
        </p>
      </PanelHeader>
      <PanelContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
            ...
            <ol className="text-sm text-blue-600/80 dark:text-blue-400/80 space-y-1 list-decimal list-inside">
              ...
              <li>Click "New Webhook" and configure a name</li>
              <li>Copy the webhook URL and paste it in your config</li>
            </ol>
            <a

...
import { getNotificationsFn, getRecentNotificationsFn, getUnreadCountFn } from '~/fn/notifications';

export const notificationsQueryOptions = (limit: number = 20, offset: number = 0) =>
  queryOptions({

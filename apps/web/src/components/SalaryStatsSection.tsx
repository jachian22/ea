      ...
      <div className="container mx-auto px-4 relative z-[2]">
        <FadeIn>
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div>
              <h2 className="text-primary font-mono text-sm font-semibold tracking-wide uppercase mb-2">
                Market Data
              </h2>
            ...
            <p className="text-muted-foreground mt-4 md:mt-0 max-w-md text-right">
              The data speaks for itself. It's one of the highest-paying and most secure careers in
              tech.
            </p>
          </div>
        </FadeIn>
              ...
              <FadeIn key={index} delay={index * 100} className="h-full">
                <div className="p-6 rounded-2xl h-full flex flex-col border border-border bg-card/50 hover:bg-card transition-colors group">
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <span className="text-xs font-mono text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-400/10 px-2 py-1 rounded-full">
                      {stat.trend}
                    </span>
                  </div>

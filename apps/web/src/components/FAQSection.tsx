...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Full stack engineer salaries vary by location and experience. Entry-level: $80k-$100k, Mid-level: $115k-$140k, Senior: $150k-$200k+. According to recent data from Glassdoor and Indeed, the national average is around $130,000 per year. Salaries are typically higher in tech hubs like San Francisco, New York, and Seattle.',
  },
  {
        ...
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground sm:text-xl max-w-3xl mx-auto leading-relaxed">
              Everything you need to know about becoming a full stack engineer, from career paths to
              salary expectations.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={200}>
          <div className="max-w-4xl mx-auto">
            <Accordion
              type="single"
              collapsible
              className="w-full glass-card rounded-2xl overflow-hidden"
            >
              {faqs.map((faq, index) => (
                <AccordionItem
                  key={index}
                  value={`item-${index}`}
                  className="px-6 border-b border-border last:border-0 data-[state=open]:bg-muted/50 transition-colors"
                >

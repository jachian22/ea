        ...
        <FadeIn delay={400}>
          <div className="mt-24 pt-12 border-t border-border flex flex-wrap justify-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <div className="text-xl font-bold text-foreground flex items-center gap-2">
              <div className="w-6 h-6 bg-foreground rounded-full"></div> COMPANY A
            </div>
            <div className="text-xl font-bold text-foreground flex items-center gap-2">
              <div className="w-6 h-6 bg-foreground rounded-md"></div> STARTUP B
            </div>
            <div className="text-xl font-bold text-foreground flex items-center gap-2">
              <div className="w-6 h-6 bg-foreground rounded-sm rotate-45"></div> TECH CORP
            </div>
            <div className="text-xl font-bold text-foreground flex items-center gap-2">
              <div className="w-6 h-6 bg-foreground rounded-full border-2 border-black dark:border-white"></div>{' '}
              STUDIO
            </div>
          </div>

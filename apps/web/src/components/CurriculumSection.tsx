...
const backendTech = ['Node.js', 'Express.js', 'RESTful APIs', 'GraphQL', 'PostgreSQL', 'MongoDB'];
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Master the complete stack. From pixel-perfect frontends to scalable backend
                infrastructure.
              </p>
            </div>
                    ...
                    <div className="mt-auto space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {category.technologies.map((tech) => (
                          <span
                            key={tech}
                            className="text-xs font-mono py-1 px-2 rounded bg-muted text-muted-foreground border border-border"
                          >
                            {tech}
                          </span>
                        ))}

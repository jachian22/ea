...
import type { CalendarEventData, EmailData, GoogleIntegration, DailyBrief } from '~/db/schema';
import type {
  BriefContent,
  BriefData,
  ...
  describe('EmailAnalyzer class', () => {
    ...
    describe('groupByActionStatus', () => {
      ...
      it('should sort each group by score', () => {
        ...
        expect(grouped.needsResponse[0].score).toBeGreaterThan(grouped.needsResponse[1].score);
      });
    });
    ...
    describe('formatEmailForBrief', () => {
      it('should format email analysis for display', () => {
        const email = createMockEmail({
          ...
          snippet:
            'This is a very long snippet that should be truncated if it exceeds the maximum length allowed for display purposes.',
        });
        ...
        const analysis: EmailAnalysis = {
          ...
          signals: [
            ...
            {
              type: 'urgent_keyword',
              description: 'Contains urgent indicator: "important"',
              weight: 20,
            },
          ],
        };
...
describe('BriefGeneratorService', () => {
  ...
  describe('Brief generation options', () => {
    it('should use custom timezone', async () => {
      ...
      expect(result.success).toBe(true);
      expect(fetchEventsForDailyBrief).toHaveBeenCalledWith(expect.anything(), 'America/New_York');
    });
      ...
      const briefContent: BriefContent = {
        ...
        conversations: {
          ...
          summary: {
            totalThreads: 0,
            totalEmails: 0,
            threadsNeedingResponse: 0,
            threadsAwaitingReply: 0,
            threadsResolved: 0,
            unreadThreads: 0,
          },
          isEmpty: true,
...
describe('Convenience Functions', () => {
  ...
  describe('generateDailyBrief', () => {
    ...
    it('should pass options to the generator', async () => {
      ...
      expect(result.success).toBe(true);
      expect(fetchEventsForDailyBrief).toHaveBeenCalledWith(expect.anything(), 'Europe/London');
    });
  });
...
describe('Date and Time Formatting', () => {
  ...
  describe('formatTime', () => {
    ...
    it('should handle different time formats', () => {
      const times = ['2025-01-15T00:00:00Z', '2025-01-15T12:00:00Z', '2025-01-15T23:59:00Z'];
